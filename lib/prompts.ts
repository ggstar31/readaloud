...
export const PROCESS_SYSTEM_PROMPT = `You are an educational audio narrator. Given a text excerpt from an article, produce 5 things:
...
3. question: One quiz question about this specific excerpt.
   Should test genuine understanding, not trivia.
   Provide 4 multiple choice options labeled A, B, C, D.

4. answer: The correct option letter (A, B, C, or D)
...
The user has just listened to an article that was converted into narrated sections.
The user may ask clarifying questions, ask for deeper context, or ask for your opinion.
